...
//		@BeforeEach
//		void setUp() {
//			pipelineEventsListener = new LdioPipelineEventsListener.Builder<>().build();
//			pipelineEventsListener.registerComponent(PIPELINE_NAME, any());
//		}
//
//		@Test
//		void test_start() {
