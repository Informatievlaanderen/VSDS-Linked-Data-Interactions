...
import be.vlaanderen.informatievlaanderen.ldes.ldto.exceptions.NoValidInputComponentException;
...
public class FlowAutoConfiguration {
	...
	public ComponentExecutor componentExecutor(final ApplicationContext applicationContext,
		...
		List<LdtoTransformer> ldtoTransformers = orchestratorConfig.getComponents().stream()
