...
public class PrefixAdder {
    ...
    private static void addPotentialPrefixToNamespaceMap(Map<String, String> nameSpaceMap, Map<String, String> localNamesMap,
    ...
    private static String getPrefixCandidate(String nameSpace) {
    ...
    private static Optional<String> getStandardPrefix(String nameSpace) {
    ...
    private static void addNameSpacesAsPrefix(Model model, Map<String, String> nameSpaceMap) {
