...
class GeoJsonToWktTransformerTest {
	...
	void testPoint() throws Exception {
		...
		List<String> resultWkts = result
				.listStatements(null, createProperty("http://www.w3.org/ns/locn#geometry"), (RDFNode) null)
		...
		// assertTrue(resultWkts.contains("POINT (101
	...
	void testPolygon() throws Exception {
		...
		assertTrue(resultWkts.contains(
				"POLYGON ((100 0, 101 0, 101 1, 100 1, 100 0), (100.8 0.8, 100.8 0.2, 100.2 0.2, 100.2 0.8, 100.8 0.8), (100.95 0.9, 100.95 0.5, 100.9 0.2, 100.9 0.5, 100.95 0.9))^^http://www.opengis.net/ont/geosparql#wktLiteral"));
		assertTrue(result.listStatements(null, GEOMETRY, (RDFNode) null).toList().isEmpty());
		assertTrue(result.listStatements(null, COORDINATES, (RDFNode) null).toList().isEmpty());
	}
