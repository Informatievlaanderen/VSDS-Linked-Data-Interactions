...
public enum FragmentSize {
	...
	EXT_TWOFIFTY("http://localhost:8080/observations/by-page?pageNumber=1"),
	EXT_FIVE_HUNDRED("http://localhost:8080/observations/pagination?pageNumber=1"),
	EXT_THOUSAND("http://localhost:8080/observations/by-page1000?pageNumber=1");
	// @formatter:on
