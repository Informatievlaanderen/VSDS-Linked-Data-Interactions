...
//
// import static
// be.vlaanderen.informatievlaanderen.ldes.ldi.processors.config.LdesProcessorRelationships.DATA_RELATIONSHIP;
...
// void shouldMatchNumberOfFlowFiles(String dataSourceUrl, int numberOfRuns, int
// expectedFlowSize) {
// testRunner.setProperty("DATA_SOURCE_URL", dataSourceUrl);
//
// testRunner.run(numberOfRuns);
//
// List<MockFlowFile> dataFlowfiles =
// testRunner.getFlowFilesForRelationship(DATA_RELATIONSHIP);
//
...
// @Test
// void
// when_runningLdesClientWithStreamPropertiesFlags_expectsLdesPropertiesInFlowFile()
// {
