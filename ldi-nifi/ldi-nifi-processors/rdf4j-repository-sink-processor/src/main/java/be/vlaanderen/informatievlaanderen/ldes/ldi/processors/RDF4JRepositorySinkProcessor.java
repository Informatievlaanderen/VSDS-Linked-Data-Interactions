...
import static be.vlaanderen.informatievlaanderen.ldes.ldi.processors.config.RDF4JRepositorySinkProcessorProperties.*;
...
public class RDF4JRepositorySinkProcessor extends AbstractProcessor {
