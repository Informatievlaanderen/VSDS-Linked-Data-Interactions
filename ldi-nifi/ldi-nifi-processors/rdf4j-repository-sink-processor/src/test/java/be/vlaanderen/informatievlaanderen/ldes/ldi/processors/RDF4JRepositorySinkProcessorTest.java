...
class RDF4JRepositorySinkProcessorTest {
	...
	@BeforeEach
	void setUp() {
		testRunner = TestRunners.newTestRunner(RDF4JRepositorySinkProcessor.class);
	}

	@AfterEach
	void tearDown() {
		((RDF4JRepositorySinkProcessor) testRunner.getProcessor()).onRemoved();
	}
